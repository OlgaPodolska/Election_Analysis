...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (c_votes > winning_county_number) and (c_vote_percentage > winning_percentage):
            winning_county_number = c_votes
    ...
    winning_county_summary = (
        ...
        f"Winning Vote Count: {winning_county_number:,}\n"
